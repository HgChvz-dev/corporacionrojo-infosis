<?php namespace App\Http\Controllers;
	...
	class AdminRnovedadesSegursoftController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Empresa","name"=>"id_empresa","join"=>"t_empresas,id"];
			$this->col[] = ["label"=>"Custodia","name"=>"id_custodia","join"=>"t_custodias,id"];
			$this->col[] = ["label"=>"Cargo","name"=>"id_cargo","join"=>"t_cargos,id"];
			$this->col[] = ["label"=>"Usuario","name"=>"id_usuario","join"=>"cms_users,id"];
			$this->col[] = ["label"=>"Detalle Novedad","name"=>"detalle_novedad"];
			$this->col[] = ["label"=>"Observacion Novedades","name"=>"observacion_novedades"];
			$this->col[] = ["label"=>"Nombrev Novedad","name"=>"nombrev_novedad"];
			...
			$this->form[] = ['label'=>'Nombrev Novedad','name'=>'nombrev_novedad','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Civ Novedad','name'=>'civ_novedad','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Motivov Novedad','name'=>'motivov_novedad','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Aquienv Novedad','name'=>'aquienv_novedad','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Lugarv Novedad','name'=>'lugarv_novedad','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
	        ...
	        */
	        $this->style_css = NULL;
	        $this->style_css = ".box{display: none;}";
