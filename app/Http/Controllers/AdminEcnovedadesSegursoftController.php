<?php namespace App\Http\Controllers;
	...
	class AdminEcnovedadesSegursoftController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Usuario','name'=>'id_usuario','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cmd_users,id'];
	        ...
	        */
			...
			$this->addaction[] = ['label'=>'Aprobar','url'=>CRUDBooster::mainpath('set-status/'.crudbooster::myIdCustodia().'/[id]'),'icon'=>'fa fa-check','color'=>'danger','showIf'=>"[vobocus_novedad] == ''", 'confirmation' => true];
		...
		public function getSetStatus($status,$id) {
		   DB::table('t_novedades')->where('id',$id)->update(['vobocus_novedad'=>$status]);
		   // vobocus_novedad
