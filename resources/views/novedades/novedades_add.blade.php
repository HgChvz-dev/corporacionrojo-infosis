...
<!-- ADICIONAR DATOS AL REGISTRO DE PACIENTES -->
                    ...
                    <div class="container" style="width: 99%;">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="two">
                                    ...
                                    <div class='form-group' id='form-group-detalle_novedad' style="resize: none;">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea id='textarea_detalle_novedad' id="detalle_novedad" name="detalle_novedad" class='form-control' rows='5'></textarea>
                                    ...
                                    {{-- <div class='form-group header-group-0 ' id='form-group-observacion_novedades' style="">
                                        <label class='control-label col-sm-2'>Observacion Novedades</label>
                                        <div class="col-sm-10">
                                            <input type='text' title="Observacion Novedades" maxlength=200 class='form-control' name="observacion_novedades" id="observacion_novedades" value=''/>
                                            <div class="text-danger"></div>
                                            <p class='help-block'></p>
                                        </div>
                                    </div> --}}
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="three">
                                    ...
                                    <div class='form-group header-group-0 ' id='form-group-nombrev_novedad' style="">
                                        ...
                                        <div class="col-sm-10">
                                            <input type='text' title="Nombre(s) Apellido(s)" maxlength=60 class='form-control' name="nombrev_novedad" id="nombrev_novedad" value=''/>
                                            <div class="text-danger"></div>
                                            <p class='help-block'></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class='form-group header-group-0 ' id='form-group-civ_novedad' style="">
                                        ...
                                        <div class="col-sm-10">
                                            <input type='text' title="Nro. C.I Exp.." maxlength=15 class='form-control' name="civ_novedad" id="civ_novedad" value=''/>
                                            <div class="text-danger"></div>
                                            <p class='help-block'></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class='form-group header-group-0 ' id='form-group-motivov_novedad' style="">
                                        ...
                                        <div class="col-sm-10">
                                            <input type='text' title="Motivo Ingreso" maxlength=200 class='form-control' name="motivov_novedad" id="motivov_novedad" value=''/>
                                            <div class="text-danger"></div>
                                            <p class='help-block'></p>
                                        </div>
                                    </div>
                                    <div class='form-group header-group-0 ' id='form-group-aquienv_novedad' style="">
                                        ...
                                        <div class="col-sm-10">
                                            <input type='text' title="Busca a" maxlength=60 class='form-control' name="aquienv_novedad" id="aquienv_novedad" value=''/>
                                            <div class="text-danger"></div>
                                            <p class='help-block'></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class='form-group header-group-0 ' id='form-group-lugarv_novedad' style="">
                                        ...
                                        <div class="col-sm-10">
                                            <input type='text' title="Lugar Ingreso" maxlength=50 class='form-control' name="lugarv_novedad" id="lugarv_novedad" value=''/>
                                            <div class="text-danger"></div>
                                            <p class='help-block'></p>
                                        </div>
                                    </div>
                            ...
                            <div class='form-group header-group-0 ' id='form-group-observacion_novedades' style="">
                                ...
                                <div class="col-sm-10">
                                    <input type='text' title="Observacion Novedades o Ingreso" maxlength=200 class='form-control' name="observacion_novedades" id="observacion_novedades" value=''/>
                                    <div class="text-danger"></div>
                                    <p class='help-block'></p>
                                </div>
                            </div>                            
                            <div class='form-group form-datepicker header-group-0 ' id='form-group-fecha_novedad' style="">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type='text' title="Fecha Novedad" readonly required class='form-control notfocus input_date' name="fecha_novedad" id="fecha_novedad" value='{{ date('Y-m-d') }}' />
                                    </div>
                                    <div class="text-danger"></div>
                                    <p class='help-block'></p>
                                </div>
                                ...
                                <div class='form-group header-group-0 ' id='form-group-hora_novedad' style="">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type='text' title="Hora Novedad" readonly required class='form-control notfocus ' name="hora_novedad" id="hora_novedad" value='{{ date('H:i:s') }}'/>
                                        </div>
                                        <div class="text-danger"></div>
                                        <p class='help-block'></p>
                                    </div>
                            ...
                            <div class='form-group header-group-0' id='form-group-priori_novedad' style="">
                                <label class='control-label col-sm-2'>Prioridad</label>
                                <div class="col-sm-10">
                                    <div class=" ">
                                        <label class='radio-inline'>
                                            <input type="radio" name="priori_novedad" value="Rojo"> Alta &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </label>                                            
                                        <label class='radio-inline'>
                                            <input type="radio" name="priori_novedad" value="Amarillo"> Media &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </label>
                                        <label class='radio-inline'>                                        
                                            <input type="radio" name="priori_novedad" value="Verde"> Baja
                                        </label>
                                    </div>
                                    <div class="text-danger"></div>
                                    <p class='help-block'></p>
                            ...
                            {{-- <div class='form-group header-group-0 ' id='form-group-voboemp_novedad' style="">
                                <label class='control-label col-sm-2'>VoBo Empresa de Seguridad
                                    <span class='text-danger' title='This field is required'>*</span>
                                </label>

                                <div class="col-sm-10">
                                    <select style='width:100%' class='form-control' id="voboemp_novedad" required    name="voboemp_novedad"  >
                                        <option value=''>** Please select a VoBo Empresa de Seguridad</option>
                                        <option  value='3'>ARMUS - CHUQUISACA</option><option  value='2'>ARMUS - COCHABAMBA</option>
                                        <option  value='1'>ARMUS - LA PAZ</option><option  value='4'>TRUJILLO - LA PAZ</option>
                                    </select>
                            ...
                            <div class='form-group header-group-0 ' id='form-group-vobocus_novedad' style="">
                                <label class='control-label col-sm-2'>VoBo Empresa Custodiada
                                    <span class='text-danger' title='This field is required'>*</span>
                                </label>

                                <div class="col-sm-10">
                                    <select style='width:100%' class='form-control' id="vobocus_novedad" required name="vobocus_novedad">
                                        <option value=''>** Please select a VoBo Empresa Custodiada</option>
                                        <option  value='1'>EMPRESA DE RELACION</option>
                                    </select>
                                    <div class="text-danger"></div>
                                    <p class='help-block'></p>
                                </div>
                            ...
                            <div class="col-sm-10">
                                ...
                                @if(CRUDBooster::isCreate() || CRUDBooster::isUpdate())
                                    ...
                                    @if(CRUDBooster::isCreate() && $button_addmore==TRUE && $command == 'add')
                                        <input type="submit" id="btnCreateM" name="submit" value='{{cbLang("button_save_more")}}' class='btn btn-success'>
                                    @endif

                                    @if($button_save && $command != 'detail')
                                        <input type="submit" id="btnCreateN" name="submit" value='{{cbLang("button_save")}}' class='btn btn-success'>
                                    @endif
