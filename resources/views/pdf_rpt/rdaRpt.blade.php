...
<html lang="es-ES">
    ...
    <body>
        <header>
            <table border=0 cellpadding=0 cellspacing=0 width="100%">
                <tr>
                    ...
                    <td class=xl7230306>DETALLE DE ASIGNACIONES</td>
        ...
        <main>
            <table border=0 cellpadding=0 cellspacing=0 width="100%"> 
                <tr>
                    <td class=xl6830306a>RR.HH</td>
                    <td class=xl6830306b>DETALLE DEL CASO</td>
                    <td class=xl6830306c>OBSERVACION</td>
                </tr>

                @foreach ($datoEs as $valor)
                    <tr>
                        <td class=styleDataGen >
                            <b>CODIGO RRHH</b><br>{{ strtoupper($valor['codigo_rrhh']) }}<br>
                            <b>NOMBRE APELLIDO</b><br> {{ strtoupper($valor['nomape_rrhh']) }}<br>
                            <b>ALIAS</b><br> {{ strtoupper($valor['alias_rrhh']) }}
                        </td>

                        <td class=styleDataDetall >
                            <b>Nro. CASO</b><br> {{ strtoupper($valor['nrocaso_asigcasos']) }}<br>
                            <b>CODIGO</b><br> {{ strtoupper($valor['codigo_asigcasos']) }}<br>
                            <b>TIPO</b><br> {{ strtoupper($valor['detalle_tipodenun']) }}<br>
                            <b>DETALLE DEL CASO</b><br> {!! strtoupper($valor['detalle_asigcasos']) !!}<br>
                        </td>

                        <td class=styleObser >
                            <b>FECHA RECEPCIÓN</b><br> {{ date("d/m/Y", strtotime($valor['fecha_asigcasos'])) }}
                        </td>
                    </tr>
                    <?php $x = $x + 1; ?>
                @endforeach    
